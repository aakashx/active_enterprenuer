<?php
    ...
    if(isset($_POST['login'])){
        ...
        $query = "SELECT username,password FROM investor WHERE email='$formemail'";
        ...
        if(mysqli_num_rows($result)>0){
            ...
            if(password_verify($formpass,$hashedpass)){
                ...
                $loginError = "<div class='alert alert-danger'>Wrong password / username combination.Try again.New Investor<a href='login_investor.php'> Sign up</a></div>";
            }
        }else{
            //there is no reult in database
            //error message
            $loginError = "<div class='alert alert-danger'>No such user in database.Please try again.New Investor<a href='login_investor.php'> Sign up</a><a class='close' data-dismiss='alert'>&times;</a></div>";
        }
    }
...
?>
        <h1 style="padding-top:60px;">LOGIN FOR INVESTER</h1>
        <?php echo $loginError; ?>
