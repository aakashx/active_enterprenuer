<?php
    ...
    if(isset($_POST["signup"])){
        ...
        if( $username && $password && $email && $phone){
            ...
            $query = "INSERT INTO users(id,username,password,email,phone_no,signup_time) VALUES (NULL, '$username' , '$password' ,'$email','$phone' , CURRENT_TIMESTAMP )";
...
<h1 style="padding-top:40px; font-size:24px;"><strong>SIGN UP USER</strong></h1>
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?id=<?php echo $clientId; ?>" method="post" class="row">
    ...
    <div class="col-sm-12">
        <hr>
        <a type="button" class="btn btn-primary btn-sm" href="login_user.php">Have a account</a> 
