    ...
    if(isset($_POST['login'])){
        ...
        if(mysqli_num_rows($result)>0){
            ...
            if(password_verify($formpass,$hashedpass)){
                ...
                $loginError = "<div class='alert alert-danger'>Wrong password / username combination.Try again.New User<a href='login_user.php'> Sign up</a></div>";
            }
        }else{
...
?>
        <h1 style="padding-top:60px;">Login into your  account</h1>
        <?php echo $loginError; ?>
